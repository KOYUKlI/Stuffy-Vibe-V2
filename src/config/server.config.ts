...
export const SERVER_CATEGORIES: CategoryConfig[] = [
  {
    ...
    channels: [
      ...
      { name: CHANNEL_NAMES.announcements, type: ChannelType.GuildText, readonly: true },
      { name: CHANNEL_NAMES.guide, type: ChannelType.GuildText, readonly: true },
      { name: CHANNEL_NAMES.roles, type: ChannelType.GuildText, readonly: true, botAccess: true },
    ],
  },
  {
    name: '◈・LOUNGE',
  ...
  },
  {
    ...
    channels: [
      ...
      { name: '🎵・musique-bot', type: ChannelType.GuildText, memberOnly: true },
      { name: '🎲・fun-bot', type: ChannelType.GuildText, memberOnly: true },
