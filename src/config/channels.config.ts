...
export const SERVER_CATEGORIES: CategoryConfig[] = [
  {
    ...
    channels: [
      ...
      { name: CHANNEL_NAMES.rules, type: ChannelType.GuildText, profile: 'entry-readonly' },
      { name: CHANNEL_NAMES.guide, type: ChannelType.GuildText, profile: 'entry-readonly' },
      { name: CHANNEL_NAMES.roles, type: ChannelType.GuildText, profile: 'member-readonly' },
    ],
  },
  {
    name: '◈・LOUNGE',
    ...
    channels: [
      ...
      { name: '📌・annonces-potes', type: ChannelType.GuildText, profile: 'member-readonly' },
    ],
  },
  {
    name: '◇・GAMING',
  ...
  },
  {
    ...
    profile: 'member',
    channels: [
      { name: '📅・events', type: ChannelType.GuildText, profile: 'member-chat' },
      {
        name: '🎞️・clips',
        type: ChannelType.GuildForum,
        fallbackType: ChannelType.GuildText,
      ...
      { name: CHANNEL_NAMES.bestOf, type: ChannelType.GuildText, profile: 'bot-publication' },
      {
        name: '💡・suggestions',
        type: ChannelType.GuildForum,
        fallbackType: ChannelType.GuildText,
      ...
      { name: CHANNEL_NAMES.freeGames, type: ChannelType.GuildText, profile: 'bot-publication' },
      { name: CHANNEL_NAMES.patchNotes, type: ChannelType.GuildText, profile: 'bot-publication' },
    ],
  },
  {
    name: '⌁・BOTS',
    ...
    channels: [
      ...
      { name: '🎵・musique-bot', type: ChannelType.GuildText, profile: 'member-chat' },
      { name: '🎲・fun-bot', type: ChannelType.GuildText, profile: 'member-chat' },
      { name: CHANNEL_NAMES.stats, type: ChannelType.GuildText, profile: 'bot-publication' },
      { name: CHANNEL_NAMES.botConfig, type: ChannelType.GuildText, profile: 'bot-staff' },
    ],
  },
  {
    name: '🔒・STAFF',
    ...
    channels: [
      ...
      { name: CHANNEL_NAMES.logs, type: ChannelType.GuildText, profile: 'bot-staff' },
      { name: '🚨・signalements', type: ChannelType.GuildText, profile: 'staff' },
      { name: CHANNEL_NAMES.tickets, type: ChannelType.GuildText, profile: 'bot-staff' },
  ...
  },
  {
    ...
    channels: [
      ...
      { name: '🎧・music', type: ChannelType.GuildVoice, profile: 'member-chat' },
      { name: CHANNEL_NAMES.tempVoice, type: ChannelType.GuildVoice, profile: 'bot-publication' },
